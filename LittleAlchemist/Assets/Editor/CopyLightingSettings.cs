...
static class CopyLightingSettings
{
    ...
    const string k_CopySettingsMenuPath = "Tools/Rendering Seting/Copy Lighting Settings";
    const string k_PasteSettingsMenuPath = "Tools/Rendering Seting/Paste Lighting Settings";
    const string k_PasteSettingsAllMenuPath = "Tools/Rendering Seting/Paste Lighting Settings in open Scenes";
#else
